...
Config.Outfits = {
    ["police"] = {
        ["male"] = {
            [1] = {
                ...
                outfitData = {
                    ...
                    ["vest"]        = { item = 1, texture = 1},  -- Body Vest
                    ["torso2"]      = { item = 1, texture = 0},  -- Jas / Vesten
        ...
        ["female"] = {
            [1] = {
                outfitLabel = "Vrouwen Lange Mouw",
                outfitData = {
                    ...
                    ["torso2"]      = { item = 3, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 75, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 6, texture = 0},  -- Decals
                    ["accessory"]   = { item = 8, texture = 0},  -- Nek / Das
            ...
            [2] = {
                outfitLabel = "Vrouwelijke Motor",
                outfitData = {
                    ["pants"]       = { item = 100,texture = 0},  -- Broek
                    ["arms"]        = { item = 3, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 65, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 237, texture = 0},  -- Jas / Vesten
                    ["shoes"]       = { item = 75, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 6, texture = 0},  -- Decals
                    ["accessory"]   = { item = 8, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 2, texture = 0},  -- Tas
    ...
    ["ambulance"] = {
        ["male"] = {
            ...
            [2] = {
                outfitLabel = "Ambulance Winter Jas",
                outfitData = {
                    ["pants"]       = { item = 49,texture = 0},  -- Broek
                    ["arms"]        = { item = 86, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 75, texture = 3},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 269, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 25, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 0, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 0, texture = 0},  -- Tas
			...
			[3] = {
                outfitLabel = "Ambulance MMT",
                outfitData = {
                    ["pants"]       = { item = 49,texture = 4},  -- Broek
                    ["arms"]        = { item = 86, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 51, texture = 4},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
			...
			[4] = {
                outfitLabel = "Ambulance OVDG",
                outfitData = {
                    ["pants"]       = { item = 49,texture = 3},  -- Broek
                    ["arms"]        = { item = 85, texture = 0},  -- Armen
                    ["t-shirt"]     = { item = 51, texture = 3},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 151, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 25, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 0, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 0, texture = 0},  -- Tas
