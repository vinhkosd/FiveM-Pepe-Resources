...
StoreRob.Functions.ClosePinpad = function(HasPutin) {
    ...
    $.post('http://fw-traphouse/PinpadClose', JSON.stringify({
...
$(document).on('keydown', function() {
    switch(event.keyCode) {
        ...
        case 13:
            var v = $("#PINbox").val();
            if (v == "") {
                $.post('http://fw-traphouse/ClickFail', JSON.stringify({}))
                $.post('http://fw-traphouse/ErrorMessage', JSON.stringify({
                ...
                $("#PINbox").val("");
                $.post('http://fw-traphouse/Click', JSON.stringify({}))
                $.post('http://fw-traphouse/EnterPincode', JSON.stringify({
                    pin: data.pin
                }))
