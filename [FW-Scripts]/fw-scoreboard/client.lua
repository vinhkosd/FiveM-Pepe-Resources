...
AddEventHandler('Framework:Client:OnPlayerLoaded', function()
    isLoggedIn = true
    Framework.Functions.TriggerCallback('fw-scoreboard:server:GetConfig', function(config)
    ...
    while true do
        if IsControlJustPressed(0, Config.OpenKey) then
            if not scoreboardOpen then
                    Framework.Functions.TriggerCallback('fw-scoreboard:server:GetActiveCops', function(cops)
                        Framework.Functions.TriggerCallback('fw-scoreboard:server:GetActiveEms', function(ambulance)
...
RegisterNetEvent('fw-scoreboard:client:SetActivityBusy')
AddEventHandler('fw-scoreboard:client:SetActivityBusy', function(activity, busy)
