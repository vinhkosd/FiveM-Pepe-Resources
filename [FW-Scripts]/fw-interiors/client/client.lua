...
function HouseRobTierOne(spawn)
    local objects = {}
    local POIOffsets = {}
	POIOffsets.exit = json.decode('{"z":39.8,"y":15.6,"x":-3.66,"h":0.0}')
	DoScreenFadeOut(500)
    while not IsScreenFadedOut() do
        Citizen.Wait(10)
    end
	...
	table.insert(objects, shell)
	Citizen.Wait(500)
	local dt = CreateObject(GetHashKey("V_16_DT"), spawn.x-1.21854400, spawn.y-1.04389600, spawn.z+1.39068600, false, false, false)
	table.insert(objects, dt)
	local mpmid01 = CreateObject(GetHashKey("V_16_mpmidapart01"), spawn.x+0.52447510, spawn.y-5.04953700, spawn.z+1.32, false, false, false)
	table.insert(objects, mpmid01)
	local mpmid09 = CreateObject(GetHashKey("V_16_mpmidapart09"), spawn.x+0.82202150, spawn.y+2.29612000, spawn.z+1.88, false, false, false)
	table.insert(objects, mpmid09)
	local mpmid07 = CreateObject(GetHashKey("V_16_mpmidapart07"), spawn.x-1.91445900, spawn.y-6.61911300, spawn.z+1.45, false, false, false)
	table.insert(objects, mpmid07)
	local mpmid03 = CreateObject(GetHashKey("V_16_mpmidapart03"), spawn.x-4.82565300, spawn.y-6.86803900, spawn.z+1.14, false, false, false)
	table.insert(objects, mpmid03)
	local midData = CreateObject(GetHashKey("V_16_midapartdeta"), spawn.x+2.28558400, spawn.y-1.94082100, spawn.z+1.32, false, false, false)
	table.insert(objects, midData)
	local glow = CreateObject(GetHashKey("V_16_treeglow"), spawn.x-1.37408500, spawn.y-0.95420070, spawn.z+1.135, false, false, false)
	table.insert(objects, glow)
	local curtins = CreateObject(GetHashKey("V_16_midapt_curts"), spawn.x-1.96423300, spawn.y-0.95958710, spawn.z+1.280, false, false, false)
	table.insert(objects, curtins)
	local mpmid13 = CreateObject(GetHashKey("V_16_mpmidapart13"), spawn.x-4.65580700, spawn.y-6.61684000, spawn.z+1.259, false, false, false)
	table.insert(objects, mpmid13)
	local mpcab = CreateObject(GetHashKey("V_16_midapt_cabinet"), spawn.x-1.16177400, spawn.y-0.97333810, spawn.z+1.27, false, false, false)
	table.insert(objects, mpcab)
	local mpdecal = CreateObject(GetHashKey("V_16_midapt_deca"), spawn.x+2.311386000, spawn.y-2.05385900, spawn.z+1.297, false, false, false)
	table.insert(objects, mpdecal)
	local mpdelta = CreateObject(GetHashKey("V_16_mid_hall_mesh_delta"), spawn.x+3.69693000, spawn.y-5.80020100, spawn.z+1.293, false, false, false)
	table.insert(objects, mpdelta)
	local beddelta = CreateObject(GetHashKey("V_16_mid_bed_delta"), spawn.x+7.95187400, spawn.y+1.04246500, spawn.z+1.28402300, false, false, false)
	table.insert(objects, beddelta)
	local bed = CreateObject(GetHashKey("V_16_mid_bed_bed"), spawn.x+6.86376900, spawn.y+1.20651200, spawn.z+1.33589100, false, false, false)
	table.insert(objects, bed)
	local beddecal = CreateObject(GetHashKey("V_16_MID_bed_over_decal"), spawn.x+7.82861300, spawn.y+1.04696700, spawn.z+1.34753700, false, false, false)
	table.insert(objects, beddecal)
	local bathDelta = CreateObject(GetHashKey("V_16_mid_bath_mesh_delta"), spawn.x+4.45460500, spawn.y+3.21322800, spawn.z+1.21116100, false, false, false)
	table.insert(objects, bathDelta)
	local bathmirror = CreateObject(GetHashKey("V_16_mid_bath_mesh_mirror"), spawn.x+3.57740800, spawn.y+3.25032000, spawn.z+1.48871300, false, false, false)
	table.insert(objects, bathmirror)
	--props
	local beerbot = CreateObject(GetHashKey("Prop_CS_Beer_Bot_01"), spawn.x+1.73134600, spawn.y-4.88520200, spawn.z+1.91083000, false, false, false)
	local couch = CreateObject(GetHashKey("v_res_mp_sofa"), spawn.x-1.48765600, spawn.y+1.68100600, spawn.z+1.33640500, false, false, false)
	local chair = CreateObject(GetHashKey("v_res_mp_stripchair"), spawn.x-4.44770800, spawn.y-1.78048800, spawn.z+1.21640500, false, false, false)
	local chair2 = CreateObject(GetHashKey("v_res_tre_chair"), spawn.x+2.91325400, spawn.y-5.27835100, spawn.z+1.22746400, false, false, false)
	local plant = CreateObject(GetHashKey("Prop_Plant_Int_04a"), spawn.x+2.78941300, spawn.y-4.39133900, spawn.z+2.12746400, false, false, false)
	local lamp = CreateObject(GetHashKey("v_res_d_lampa"), spawn.x-3.61473100, spawn.y-6.61465100, spawn.z+2.09373700, false, false, false)
	local fridge = CreateObject(GetHashKey("v_res_fridgemodsml"), spawn.x+1.90339700, spawn.y-3.80026800, spawn.z+1.29917900, false, false, false)
	local micro = CreateObject(GetHashKey("prop_micro_01"), spawn.x+2.03442400, spawn.y-4.64585100, spawn.z+2.28995600, false, false, false)
	local sideBoard = CreateObject(GetHashKey("V_Res_Tre_SideBoard"), spawn.x+2.84053000, spawn.y-4.30947100, spawn.z+1.24577300, false, false, false)
	local bedSide = CreateObject(GetHashKey("V_Res_Tre_BedSideTable"), spawn.x-3.50363200, spawn.y-6.55289400, spawn.z+1.30625800, false, false, false)
	local lamp2 = CreateObject(GetHashKey("v_res_d_lampa"), spawn.x+2.69674700, spawn.y-3.83123500, spawn.z+2.09373700, false, false, false)
	local plant2 = CreateObject(GetHashKey("v_res_tre_tree"), spawn.x-4.96064800, spawn.y-6.09898500, spawn.z+1.31631400, false, false, false)
	local table = CreateObject(GetHashKey("V_Res_M_DineTble_replace"), spawn.x-3.50712600, spawn.y-4.13621600, spawn.z+1.29625800, false, false, false)
	local tv = CreateObject(GetHashKey("Prop_TV_Flat_01"), spawn.x-5.53120400, spawn.y+0.76299670, spawn.z+2.17236000, false, false, false)
	local plant3 = CreateObject(GetHashKey("v_res_tre_plant"), spawn.x-5.14112800, spawn.y-2.78951000, spawn.z+1.25950800, false, false, false)
	local chair3 = CreateObject(GetHashKey("v_res_m_dinechair"), spawn.x-3.04652400, spawn.y-4.95971200, spawn.z+1.19625800, false, false, false)
	local lampStand = CreateObject(GetHashKey("v_res_m_lampstand"), spawn.x+1.26588400, spawn.y+3.68883900, spawn.z+1.35556700, false, false, false)
	local stool = CreateObject(GetHashKey("V_Res_M_Stool_REPLACED"), spawn.x-3.23216300, spawn.y+2.06159000, spawn.z+1.20556700, false, false, false)
	local chair4 = CreateObject(GetHashKey("v_res_m_dinechair"), spawn.x-2.82237200, spawn.y-3.59831300, spawn.z+1.25950800, false, false, false)
	local chair5 = CreateObject(GetHashKey("v_res_m_dinechair"), spawn.x-4.14955100, spawn.y-4.71316600, spawn.z+1.19625800, false, false, false)
	local chair6 = CreateObject(GetHashKey("v_res_m_dinechair"), spawn.x-3.80622900, spawn.y-3.37648300, spawn.z+1.19625800, false, false, false)
	local plant4 = CreateObject(GetHashKey("v_res_fa_plant01"), spawn.x+2.97859200, spawn.y+2.55307400, spawn.z+1.85796300, false, false, false)
	local storage = CreateObject(GetHashKey("v_res_tre_storageunit"), spawn.x+8.47819500, spawn.y-2.50979300, spawn.z+1.19712300, false, false, false)
	local storage2 = CreateObject(GetHashKey("v_res_tre_storagebox"), spawn.x+9.75982700, spawn.y-1.35874100, spawn.z+1.29625800, false, false, false)
	local basketmess = CreateObject(GetHashKey("v_res_tre_basketmess"), spawn.x+8.70730600, spawn.y-2.55503600, spawn.z+1.94059590, false, false, false)
	local lampStand2 = CreateObject(GetHashKey("v_res_m_lampstand"), spawn.x+9.54306000, spawn.y-2.50427700, spawn.z+1.30556700, false, false, false)
	local plant4 = CreateObject(GetHashKey("Prop_Plant_Int_03a"), spawn.x+9.87521400, spawn.y+3.90917400, spawn.z+1.20829700, false, false, false)
	local basket = CreateObject(GetHashKey("v_res_tre_washbasket"), spawn.x+9.39091500, spawn.y+4.49676300, spawn.z+1.19625800, false, false, false)
	local wardrobe = CreateObject(GetHashKey("V_Res_Tre_Wardrobe"), spawn.x+8.46626300, spawn.y+4.53223600, spawn.z+1.19425800, false, false, false)
	local basket2 = CreateObject(GetHashKey("v_res_tre_flatbasket"), spawn.x+8.51593000, spawn.y+4.55647300, spawn.z+3.46737300, false, false, false)
	local basket3 = CreateObject(GetHashKey("v_res_tre_basketmess"), spawn.x+7.57797200, spawn.y+4.55198800, spawn.z+3.46737300, false, false, false)
	local basket4 = CreateObject(GetHashKey("v_res_tre_flatbasket"), spawn.x+7.12286400, spawn.y+4.54689200, spawn.z+3.46737300, false, false, false)
	local wardrobe2 = CreateObject(GetHashKey("V_Res_Tre_Wardrobe"), spawn.x+7.24382000, spawn.y+4.53423500, spawn.z+1.19625800, false, false, false)
	local basket5 = CreateObject(GetHashKey("v_res_tre_flatbasket"), spawn.x+8.03364600, spawn.y+4.54835500, spawn.z+3.46737300, false, false, false)
	local switch = CreateObject(GetHashKey("v_serv_switch_2"), spawn.x+6.28086900, spawn.y-0.68169880, spawn.z+2.30326000, false, false, false)
	local table2 = CreateObject(GetHashKey("V_Res_Tre_BedSideTable"), spawn.x+5.84416200, spawn.y+2.57377400, spawn.z+1.22089100, false, false, false)
	local lamp3 = CreateObject(GetHashKey("v_res_d_lampa"), spawn.x+5.84912100, spawn.y+2.58001100, spawn.z+1.95311890, false, false, false)
	--local laundry = CreateObject(GetHashKey("v_res_mlaundry"), spawn.x+5.77729800, spawn.y+4.60211400, spawn.z+1.19674400, false, false, false)
	local ashtray = CreateObject(GetHashKey("Prop_ashtray_01"), spawn.x-1.24716200, spawn.y+1.07820500, spawn.z+1.87089300, false, false, false)
	local candle1 = CreateObject(GetHashKey("v_res_fa_candle03"), spawn.x-2.89289900, spawn.y-4.35329700, spawn.z+2.02881310, false, false, false)
	local candle2 = CreateObject(GetHashKey("v_res_fa_candle02"), spawn.x-3.99865700, spawn.y-4.06048500, spawn.z+2.02530190, false, false, false)
	local candle3 = CreateObject(GetHashKey("v_res_fa_candle01"), spawn.x-3.37733400, spawn.y-3.66639800, spawn.z+2.02526200, false, false, false)
	local woodbowl = CreateObject(GetHashKey("v_res_m_woodbowl"), spawn.x-3.50787400, spawn.y-4.11983000, spawn.z+2.02589900, false, false, false)
	local tablod = CreateObject(GetHashKey("V_Res_TabloidsA"), spawn.x-0.80513000, spawn.y+0.51389600, spawn.z+1.18418800, false, false, false)
	local tapeplayer = CreateObject(GetHashKey("Prop_Tapeplayer_01"), spawn.x-1.26010100, spawn.y-3.62966400, spawn.z+2.37883200, false, false, false)
	local woodbowl2 = CreateObject(GetHashKey("v_res_tre_fruitbowl"), spawn.x+2.77764900, spawn.y-4.138297000, spawn.z+2.10340100, false, false, false)
	local sculpt = CreateObject(GetHashKey("v_res_sculpt_dec"), spawn.x+3.03932200, spawn.y+1.62726400, spawn.z+3.58363900, false, false, false)
	local jewlry = CreateObject(GetHashKey("v_res_jewelbox"), spawn.x+3.04164100, spawn.y+0.31671810, spawn.z+3.58363900, false, false, false)
	local basket6 = CreateObject(GetHashKey("v_res_tre_basketmess"), spawn.x-1.64906300, spawn.y+1.62675900, spawn.z+1.39038500, false, false, false)
	local basket7 = CreateObject(GetHashKey("v_res_tre_flatbasket"), spawn.x-1.63938900, spawn.y+0.91133310, spawn.z+1.39038500, false, false, false)
	local basket8 = CreateObject(GetHashKey("v_res_tre_flatbasket"), spawn.x-1.19923400, spawn.y+1.69598600, spawn.z+1.39038500, false, false, false)
	local basket9 = CreateObject(GetHashKey("v_res_tre_basketmess"), spawn.x-1.18293800, spawn.y+0.91436380, spawn.z+1.39038500, false, false, false)
	local bowl = CreateObject(GetHashKey("v_res_r_sugarbowl"), spawn.x-0.26029210, spawn.y-6.66716800, spawn.z+3.77324900, false, false, false)
	local breadbin = CreateObject(GetHashKey("Prop_Breadbin_01"), spawn.x+2.09788500, spawn.y-6.57634000, spawn.z+2.24041900, false, false, false)
	local knifeblock = CreateObject(GetHashKey("v_res_mknifeblock"), spawn.x+1.82084700, spawn.y-6.58438500, spawn.z+2.27399500, false, false, false)
	local toaster = CreateObject(GetHashKey("prop_toaster_01"), spawn.x-1.05790700, spawn.y-6.59017400, spawn.z+2.26793200, false, false, false)
	local wok = CreateObject(GetHashKey("prop_wok"), spawn.x+2.01728800, spawn.y-5.57091500, spawn.z+2.31793200, false, false, false)
	local plant5 = CreateObject(GetHashKey("Prop_Plant_Int_03a"), spawn.x+2.55015600, spawn.y+4.60183900, spawn.z+1.20829700, false, false, false)
	local tumbler = CreateObject(GetHashKey("p_tumbler_cs2_s"), spawn.x-0.90916440, spawn.y-4.24099100, spawn.z+2.24693200, false, false, false)
	local wisky = CreateObject(GetHashKey("p_whiskey_bottle_s"), spawn.x-0.92809300, spawn.y-3.99099100, spawn.z+2.24693200, false, false, false)
	local tissue = CreateObject(GetHashKey("v_res_tissues"), spawn.x+7.95889300, spawn.y-2.54847100, spawn.z+1.94013400, false, false, false)
	local pants = CreateObject(GetHashKey("V_16_Ap_Mid_Pants4"), spawn.x+7.55366500, spawn.y-0.25457100, spawn.z+1.33009200, false, false, false)
	local pants2 = CreateObject(GetHashKey("V_16_Ap_Mid_Pants5"), spawn.x+7.76753200, spawn.y+3.00476500, spawn.z+1.33052800, false, false, false)
	local hairdryer = CreateObject(GetHashKey("v_club_vuhairdryer"), spawn.x+8.12616000, spawn.y-2.50562000, spawn.z+1.96009390, false, false, false)
