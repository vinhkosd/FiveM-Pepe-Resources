...
RegisterNetEvent('fw-prison:client:set:in:jail')
AddEventHandler('fw-prison:client:set:in:jail', function(Name, Months, CitizenId, Date)
...
function JailIntro(Name, Months, CitizenId, Date)
    ...
    TriggerEvent('fw-sound:client:play', 'handcuff', 0.4)
    ...
    TriggerEvent('fw-sound:client:play', 'jail-photo', 0.4)
    Citizen.Wait(3000) 
    TriggerEvent('fw-sound:client:play', 'jail-photo', 0.4)
    Citizen.Wait(3000) 
    ...
    TriggerServerEvent("fw-prison:server:set:jail:items", Months)
    TriggerEvent('fw-prison:client:enter:prison', Months, true)
    Framework.Functions.Notify("Je zit in de gevangenis voor "..Months.." maanden..", "error", 6500)
end
...
function AddMugshot(Name, Months, CitizenId, Date)
 ...
 exports['fw-assets']:RequestAnimationDict("mp_character_creation@lineup@male_a")
