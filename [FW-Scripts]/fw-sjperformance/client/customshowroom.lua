                                        ...
                                        if selected then
                                            if IsControlJustPressed(1, 18) then
                                                if CustomModelLoaded then
                                                    TriggerServerEvent('fw-sjperformance:server:SetCustomShowroomVeh', button.model, ClosestCustomVehicle)
                                                end
                                            end
                                        end
                                    end
                                ...
                                if QBCustom.ShowroomPositions2[ClosestCustomVehicle].buying then
                                    if Framework.Shared.Vehicles[QBCustom.ShowroomPositions2[ClosestCustomVehicle].vehicle] ~= nil then
                                        ...
                                        if IsDisabledControlJustPressed(0, Keys["7"]) then
                                            TriggerServerEvent('fw-sjperformance:server:ConfirmVehicle', QBCustom.ShowroomPositions2[ClosestCustomVehicle])
...
RegisterNetEvent('fw-sjperformance:client:SetCustomShowroomVeh')
AddEventHandler('fw-sjperformance:client:SetCustomShowroomVeh', function(showroomVehicle, k)
    CancelEvent()
...
RegisterNetEvent('fw-sjperformance:client:ConfirmVehicle')
AddEventHandler('fw-sjperformance:client:ConfirmVehicle', function(Showroom, plate)
...
RegisterNetEvent('fw-sjperformance:client:DoTestrit')
AddEventHandler('fw-sjperformance:client:DoTestrit', function(plate)
...
RegisterNetEvent('fw-sjperformance:client:SellCustomVehicle')
AddEventHandler('fw-sjperformance:client:SellCustomVehicle', function(TargetId)
    local ped = GetPlayerPed(-1)
    ...
    if player ~= -1 and distance < 2.5 then
        ...
        if VehicleDist < 2.5 then
            TriggerServerEvent('fw-sjperformance:server:SellCustomVehicle', TargetId, ClosestCustomVehicle)
        else
...
RegisterNetEvent('fw-sjperformance:client:SetVehicleBuying')
AddEventHandler('fw-sjperformance:client:SetVehicleBuying', function(slot)
