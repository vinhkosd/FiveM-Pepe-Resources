...
RegisterNUICallback('buyVehicle', function(data)
    ...
    TriggerServerEvent('fw-sjperformance:server:buyVehicle', vehicleData, garage)
    openVehicleShop(false)
end)

RegisterNetEvent('fw-sjperformance:client:spawnBoughtVehicle')
AddEventHandler('fw-sjperformance:client:spawnBoughtVehicle', function(vehicle)
