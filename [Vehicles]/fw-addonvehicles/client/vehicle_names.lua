Citizen.CreateThread(function()
	AddTextEntry('a80', 'Honda Supra')
	AddTextEntry('trhawk', 'Jeep Track Hawk')
	AddTextEntry('EK9', 'Honda Civic')
	AddTextEntry("560sel", "Mercedes 560SEL")
    AddTextEntry("x5e53", "BMW X5")
    AddTextEntry("x5e53_bnt1", "BOTNET")
    AddTextEntry("x5e53_bumr1", "BUMPER")
    AddTextEntry("x5e53_ext1", "EXHAUST")
    AddTextEntry("x5e53_skirt1", "SKIRT")
    AddTextEntry("x5e53_split1", "VMT_BUMPER_F")
